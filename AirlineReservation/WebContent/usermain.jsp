...
<div style="position:fixed;top:200px;left:200px">
	<div style="display:inline-block;margin-right:100px">
		<a class="btn" href="<%=request.getContextPath()%>/search.jsp">Book Tickets</a>
	</div>	
	<div style="display:inline-block;margin-left:100px;margin-right:100px">
		<a class="btn" href="<%=request.getContextPath()%>/searchrecord">My Booking</a>
	</div>
	<div style="display:inline-block;margin-left:100px">
		<a class="btn" href="<%=request.getContextPath()%>/getuser">My Profile</a>
	</div>
</div>
