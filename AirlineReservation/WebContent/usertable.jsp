...
<br><br><br>
<h2 style="text-align:center">All Users</h2><br><br>
<div>
	<table>
		<thead>
			<th>UserID</th>
		...
		<tbody>
			...
			<tr>
				...
				<td><c:out value="${u.addr}"></c:out></td>
				<td><c:out value="${u.phoneno}"></c:out></td>
				<td><a id="editb" href="<%=request.getContextPath()%>/edituser?uid=<c:out value="${u.userid}"/>">EDIT</a></td>
				<td><a id="deleteb" href="<%=request.getContextPath()%>/deleteuser?uid=<c:out value="${u.userid}"/>">DELETE</a></td>			
			</tr>			
			</c:forEach>		
		</tbody>
...
<div style="text-align:center">
	<a class="button-19" href="<%=request.getContextPath()%>/adduser.jsp">ADD USER</a>
</div>
</div>
</body>
</html>